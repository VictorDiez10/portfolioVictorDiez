...
export const PinContainer = ({
  ...
  useEffect(() => {
    setIsMounted(true); // S'assurer que le composant est monté côté client
  }, []);

  if (!isMounted) {
    return null; // Empêcher le rendu avant le montage côté client
  }
...
export const PinPerspective = ({
  ...
  useEffect(() => {
    setIsMounted(true); // S'assurer que les animations se lancent après le montage
  }, []);
